...
//import com.google.firebase.storage.StorageReferecnce;
...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName, Description, Price, Pname, saveCurrentDate, saveCurrentTime,Pquantity;
    ...
    private void ValidateProductData()
    {
        ...
        {
            Toast.makeText(this, "Please input quantity of the product...", Toast.LENGTH_SHORT).show();
        }
        else
        {
    ...
    private void StoreProductInformation()
    {
        ...
        loadingBar.setMessage("Seller, please wait while we are adding the new product.");
