...
import com.example.e_shopping.LoginActivity;
        ...
        if(!name.equals("") && !phone.equals("") && !email.equals("") && !password.equals("") && !address.equals(""))
        {
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        {
                                            Toast.makeText(SellerRegistrationActivity.this,"Seller registered successfully.. ",Toast.LENGTH_LONG).show();
                                            loadingBar.dismiss();
                        ...
                        {
                            Toast.makeText(SellerRegistrationActivity.this,"Cannot register new seller.. ",Toast.LENGTH_LONG).show();
                        }
                    }
                });
        }
