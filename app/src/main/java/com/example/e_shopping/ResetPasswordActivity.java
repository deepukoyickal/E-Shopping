...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private  void verifyUser()
    {
                    ...
                    if(dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            if (!ans1.equals(answer1)) {
                                Toast.makeText(ResetPasswordActivity.this, "your first answer is incorrect", Toast
                                        .LENGTH_LONG).show();
                            } else if (!ans2.equals(answer2)) {
                                Toast.makeText(ResetPasswordActivity.this, "your second answer is incorrect", Toast
                                        .LENGTH_LONG).show();
                            }
                            else
                                {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (!newPassword.getText().toString().equals("")) {
                                            ref.child("password").setValue(newPassword.getText()
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(ResetPasswordActivity.this, "password changed successfully....", Toast
                                                                .LENGTH_LONG).show();
                        ...
                        {
                            Toast.makeText(ResetPasswordActivity.this,"you have'nt set security questions",Toast
                                    .LENGTH_LONG).show();
                        }
        ...
        {
            Toast.makeText(ResetPasswordActivity.this,"please complete the form",Toast
                    .LENGTH_LONG).show();
        }
